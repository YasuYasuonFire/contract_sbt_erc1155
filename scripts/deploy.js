...
const main = async () => {
    ...
    const nftContractFactory = await hre.ethers.getContractFactory("LabEventSBT");
    ...
    //set name
    txn = await nftContract.setName("K-LAB Event SBT Collection");
    await txn.wait();
    //set symbol
    txn = await nftContract.setSymbol("K-LAB");
    await txn.wait();
